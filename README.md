...
| Component | Best Technique | Justification |
|-----------|---------------|---------------|
| 0 | Text Preprocessing | Stop word removal + Lowercasing | Greatest precision and recall improvement |
| 1 | Stemming vs Lemmatization | Stemming (Porter) | Higher recall; suited for job description corpus |
| 2 | Phrase Query Index | Positional Index | Zero false positives; exact phrase matching |
| 3 | Dictionary Search | B-Tree (t=3) | Fewer comparisons; guaranteed O(log n) balance |
| 4 | Tolerant Retrieval | Edit Distance + K-gram Index | Handles wildcards, typos and phonetic errors |
